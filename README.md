...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-zsr1j1i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-zsr1j1i.containers.anotherwebservice.com/
...
```
git clone git@github.com:harshsinghvi/container-zsr1j1i.git
cd container-zsr1j1i
```
...
```
docker attach container-zsr1j1i
```
